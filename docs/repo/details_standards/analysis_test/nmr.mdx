...
<sup>1</sup>H NMR (400 MHz, CDCl<sub>3</sub>, 25 °C): δ [ppm] = 7.28 (dd, <i>
  J
</i> = 7.7, 1.6 Hz, 1H), 7.14 (ddd, <i>J</i> = 8.2, 7.3, 1.6 Hz, 1H), 6.74–6.66
...
(dd, <i>J</i> = 7.7, 1.6 Hz, 1H), 7.14 (ddd, <i>J</i> = 8.2, 7.3, 1.6 Hz, 1H), 6.74–6.66
(m, 2H), 4.94 (s, 2H), 4.04 (br.s, 2H), 2.12 (s, 3H). <br />

**(3) Example with solvent ratio where CDCl<sub>3</sub> is used as a reference:**

<sup>1</sup>H NMR (400 MHz, CDCl<sub>3</sub>/DMF-d<sub>7</sub> 5:1, 25 °C): δ [ppm] = 7.28
(dd, <i>J</i> = 7.7, 1.6 Hz, 1H), 7.14 (ddd, <i>J</i> = 8.2, 7.3, 1.6 Hz, 1H),
6.74–6.66 (m, 2H), 4.94 (s, 2H), 4.04 (br.s, 2H), 2.12 (s, 3H).

**(4) Example with additional standard TMS:**

<sup>1</sup>H NMR (400 MHz, CDCl<sub>3</sub>, 25 °C, TMS): δ [ppm] = 7.28
(dd, <i>J</i> = 7.7, 1.6 Hz, 1H), 7.14 (ddd, <i>J</i> = 8.2, 7.3, 1.6 Hz, 1H), 6.74–6.66
(m, 2H), 4.94 (s, 2H), 4.04 (br.s, 2H), 2.12 (s, 3H).
...
<sup>1</sup>H NMR (400 MHz, MeOD-d<sub>4</sub>, 25 °C): δ [ppm] = 7.28 (dd, <i>
  J
</i> = 7.7, <i>J</i> = 1.6 Hz, 1H), 7.14 (ddd, <sup>3</sup>
<i>J</i> = 8.2, <sup>3</sup>
<i>J</i>
<sub>H,F</sub> = 7.3, <sup>4</sup>
<i>J</i> = 1.6 Hz, 1H), 6.74–6.66 (m, 2H), 4.94 (s, 2H), 4.04 (br.s, 2H), 2.12
...
<sup>1</sup>H NMR (500 MHz, MeOD-d<sub>4</sub> [3.31 ppm]): δ [ppm] = 13.23 (br.s,
0.4H, CO<sub>2</sub>H-isomer1), 12.98 (br.s, 0.6H, CO<sub>2</sub>H-isomer2), 8.24 (d,
...
H-8), 3.85 (br.s, 1H, N<i>H</i>), 3.40–3.22 (m, 2H, H-2), 3.02–2.84 (m, 1H, H-4),
...
The following ways to cite the metadata for NMR are preferred: <br />
<sup>1</sup>H NMR (400 MHz, CDCl<sub>3</sub> [7.27 ppm], ppm) δ = <br />
<sup>1</sup>H NMR (400 MHz, CDCl<sub>3</sub>, 25 °C): δ [ppm] =
...
- Rotamers: List all signals with their ratio that contributes to 1C. The sum of all <sup>13</sup>C signals should correspond to the overall number of <sup>13</sup>C atoms in the molecule. 
